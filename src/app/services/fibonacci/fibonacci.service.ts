...
//compiled by solc
const byteCode = '';
...
export class FibonacciService {
  ...
  // private readonly contractAdress =
  //   '0xAB46372916F324B3892D3849C39264A356CD4357';
  ...
  constructor(
    ...
    try {
      ...
      this.fiboContract.deploy(payload).send({
        from:'0x0e1f692BD5544EB5345357237823A440D4050384',
        gas:1500000,
        gasPrice: this.connectionService.window.web3.utils.toWei('0', 'ether')})
        .then((fiboContractInstance: any) => {
          console.log(fiboContractInstance);
          this.fiboContract.options.address=fiboContractInstance.options.address}
          );;
    } catch (error) {
      console.log(error);
    }
  ...
  callFib(value: number, from: string): Promise<any> {
    ...
    return fiboContract.methods.callFib(value).call({ from: from });
  }
}
